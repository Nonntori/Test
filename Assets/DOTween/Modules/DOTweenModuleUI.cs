...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        {
            TweenerCore<UnityEngine.Color, UnityEngine.Color, ColorOptions> t = DOTween.To(() => target.color, x => target.color = x, endValue, duration);
            t.SetTarget(target);
            return t;
        }
        ...
        {
            TweenerCore<UnityEngine.Color, UnityEngine.Color, ColorOptions> t = DOTween.ToAlpha(() => target.color, x => target.color = x, endValue, duration);
            t.SetTarget(target);
            return t;
        }
        ...
        {
            TweenerCore<UnityEngine.Color, UnityEngine.Color, ColorOptions> t = DOTween.To(() => target.effectColor, x => target.effectColor = x, endValue, duration);
            t.SetTarget(target);
            return t;
        }
        ...
        {
            TweenerCore<UnityEngine.Color, UnityEngine.Color, ColorOptions> t = DOTween.ToAlpha(() => target.effectColor, x => target.effectColor = x, endValue, duration);
            t.SetTarget(target);
            return t;
        }
        ...
        public static Tweener DOBlendableColor(this Graphic target, UnityEngine.Color endValue, float duration)
        {
            ...
            UnityEngine.Color to = new UnityEngine.Color(0, 0, 0, 0);
            return DOTween.To(() => to, x => {
                UnityEngine.Color diff = x - to;
                to = x;
                target.color += diff;
            }, endValue, duration)
